	...
	<div class="row justify-content-center">
		<div class="card col-11">
			<div class="card-header">
				<h2>Respondiendo mensaje de: {{$respuestaA[0]->name}}</h2>
			</div>
			<div class="card-body">
				<form method="post" onsubmit="return validacion()" enctype="multipart/form-data" action={{route('store_responder',$mensajePre->id)}}>
					...
					<div class="row">
						<div class="col-4">
							<label for="receptor">
								<h5>Respuesta enviada al correo:</h5>
							</label>
					...
					<div class="form-group">
						<label for="file">
							<h5>Adjuntar archivos [PDF,DOC,DOCX,JPG,GIF,PNG,EXE,RAR,ZIP]:</h5>
						</label>
