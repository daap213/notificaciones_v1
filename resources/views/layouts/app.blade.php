                        ...
                        @else
							<div class="" id="sidebar-wrapper">
								<ul id="sidebar_menu" class="sidebar-nav">
									<h2><li class="sidebar-brand"><a id="menu-toggle" align="center" style="color:Black;">Menu<i class="fas fa-comments mr-1"></i></a></li></h2>
								</ul>
								<ul class="sidebar-nav" id="sidebar">
									<h5><li><a href="{{route ('home')}}" style="color:Black;"><i class="fas fa-home"></i> Home</a></li></h5>
									<h5><li><a href="#" style="color:Black;"><i class="fas fa-portrait"></i></i> Mi perfil</a></li></h5>
									<h5><li><a href="{{route ('recibido_mensaje')}}" style="color:Black;"><i class="fas fa-bell"></i> Notificaciones
										@if(count(auth()->user()->unreadNotifications))
											<span class="badge badge-warning">{{count(auth()->user()->unreadNotifications)}}</span>
										@endif</a></li></h5>
									<h5><li><a href="{{route ('recibidoPost')}}" style="color:Black;"><i class="fas fa-mail-bulk"></i> Post</a></li></h5>
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
									<span class="dropdown-header"><h4 style="color:Black;">Mensajes no leidos:</h4></span>
